sap.ui.require([
  ...
  var sViewName = "pinaki.app.credentialManager.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "pinaki.app.credentialManager"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title pinaki.app.credentialManager"
            });
        }
      }
